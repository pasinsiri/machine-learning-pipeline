...
This file consumes preprocessed_data.csv artifact and is not related to custom inputs in conftest.py
"""
...
# run
run = wandb.init(project="sample_ml_pipeline", job_type="test_data_quality")


@pytest.fixture(scope="session")
def data():
    local_path = run.use_artifact("sample_ml_pipeline/preprocessed_data.csv:latest").file()
