"""
conftest.py
Send data from parsers to the Kolgomorov-Smirnov test in non_deterministic_test.py
This process enables pytest to consume custom input path (custom artifacts) to be tested
"""
